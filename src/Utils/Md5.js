...
/*
 ...
  */
 hex_md5(s){ return this.binl2hex(this.core_md5(this.str2binl(s), s.length * chrsz));}
 b64_md5(s){ return this.binl2b64(this.core_md5(this.str2binl(s), s.length * chrsz));}
 str_md5(s){ return this.binl2str(this.core_md5(this.str2binl(s), s.length * chrsz));}
